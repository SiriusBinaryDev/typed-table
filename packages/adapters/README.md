...
- Local adapters honor visibility, ordering, pinning, grouping, and row expansion when enabled.
- Remote queries receive the ordered sorting descriptor list and active filters.
- Server-backed grouping and faceting are intentionally out of scope in the current version.

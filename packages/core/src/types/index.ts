...
export type RemoteGroupRowInput<TData> = {
  type: "group";
  id: string;
  groupingColumnId: ColumnId<TData>;
  groupingValue: unknown;
  leafRowCount?: number | undefined;
  subRows?: readonly RemoteRowInput<TData>[] | undefined;
};

export type RemoteDataRowInput<TData> = {
  type?: "data" | undefined;
  original: TData;
  id?: string | undefined;
};

export type RemoteRowInput<TData> =
  | RemoteGroupRowInput<TData>
  | RemoteDataRowInput<TData>;

export type RemoteFacetingResult<TData> = {
  uniqueValues?: Partial<Record<ColumnId<TData>, FacetValueCount[]>> | undefined;
  minMaxValues?: Partial<Record<ColumnId<TData>, FacetMinMaxValues>> | undefined;
};
...
export type TableQueryResult<TData> = {
  rows: readonly TData[];
  total: number;
  groupedRows?: readonly RemoteRowInput<TData>[] | undefined;
  faceting?: RemoteFacetingResult<TData> | undefined;
};
...
export type TableModel<TData> = {
  ...
  pageCount: number;
  totalRows: number;
  facetedUniqueValues?: Partial<Record<ColumnId<TData>, FacetValueCount[]>> | undefined;
  facetedMinMaxValues?: Partial<Record<ColumnId<TData>, FacetMinMaxValues>> | undefined;
};

        ...
        <div className="basic-column-controls">
          ...
          <div className="basic-row-order-list">
            {orderedUsers.map((user, index) => (
              <div key={user.id} className="basic-row-order-card">
          ...
          <p className="basic-helper">
            Manual row order changes the base local dataset order. Active sorting or grouping can
            still change the visible table order after that base order is applied.
          </p>
        </div>
    ...
    <main className="basic-example">
      <section className="basic-hero">
        ...
        <p className="basic-lede">
          A compact people table with filtering, sorting, manual row ordering, grouping,
